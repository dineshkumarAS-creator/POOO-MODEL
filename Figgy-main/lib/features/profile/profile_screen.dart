...
class _ProfileScreenState extends State<ProfileScreen> {
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text('QUICK ACCESS', style: AppTypography.small.copyWith(
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 24),
              child: Text('ACTIVE PLAN', style: AppTypography.small.copyWith(
                fontWeight: FontWeight.w900, 
                color: AppColors.textSecondary,
                letterSpacing: 1.2,
              )),
        ...
        child: Row(
          children: [
            Container(
              ...
              child: const Center(
                child: Text('RK', style: TextStyle(color: AppColors.brandPrimary, fontWeight: FontWeight.w900, fontSize: 24)),
              ),
            ),
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Ravi Kumar', style: AppTypography.h2.copyWith(fontWeight: FontWeight.w900, fontSize: 22)),
                  const SizedBox(height: 4),
                  Row(
                    children: [
                      const Icon(Icons.location_on_rounded, color: AppColors.textSecondary, size: 14),
                      const SizedBox(width: 4),
                      Text('T Nagar, Chennai', style: AppTypography.bodySmall.copyWith(color: AppColors.textSecondary, fontWeight: FontWeight.w600)),
                    ],
                  ),
                ],
              ),
            ...
            Container(
              ...
              child: const Icon(Icons.edit_outlined, color: AppColors.brandPrimary, size: 20),
            ),
          ],
        ),
      ),
  ...
  Widget _buildStatsRow() {
    return Padding(
      ...
      child: Row(
        children: [
          Expanded(child: _buildStatItem('Lifetime Earnings', '₹ 52,400', Icons.account_balance_wallet_outlined)),
          const SizedBox(width: 12),
          Expanded(child: _buildStatItem('Active Hours', '124 hrs', Icons.timer_outlined)),
          const SizedBox(width: 12),
          Expanded(child: _buildStatItem('Trips Done', '1.2k', Icons.local_shipping_outlined)),
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 12),
          Text(value, style: AppTypography.bodyLarge.copyWith(fontWeight: FontWeight.w900, color: Colors.black, fontSize: 16)),
          const SizedBox(height: 4),
          Text(label, textAlign: TextAlign.center, style: AppTypography.small.copyWith(color: AppColors.textSecondary, fontSize: 10, fontWeight: FontWeight.w600)),
        ],
      ),
    );
  }
    ...
    return Padding(
      ...
      child: Column(
        children: [
          Row(
            children: [
              Expanded(child: _buildQuickAccessItem(
          ...
          Row(
            children: [
              ...
              Expanded(child: _buildQuickAccessItem(
                ...
                onTap: () => setState(() => _isUpiEditing = true),
              )),
            ],
          ),
        ],
  ...
  Widget _buildQuickAccessItem(IconData icon, String title, String subtitle, Color bgColor, Color iconColor, {VoidCallback? onTap}) {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text(title, style: AppTypography.bodyMedium.copyWith(fontWeight: FontWeight.w900, color: Colors.black)),
          ...
          children: [
              ...
              children: [
                Row(
                  children: [
                    ...
                    const SizedBox(width: 12),
                    Text('Smart SaverPlan', style: AppTypography.h3.copyWith(fontWeight: FontWeight.w900, fontSize: 18)),
                  ],
                ),
                Container(
                  ...
                  child: Text('ACTIVE', style: AppTypography.small.copyWith(color: const Color(0xFF2E7D32), fontWeight: FontWeight.w900, fontSize: 9)),
                ),
              ],
            ),
            const SizedBox(height: 20),
            Text(
              'Your coverage is active. You are protected against income loss due to weather and traffic disruptions.',
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  const SizedBox(width: 8),
                  Text('Next renewal: 24 Apr 2026', style: AppTypography.small.copyWith(fontWeight: FontWeight.w700, color: AppColors.textPrimary)),
                  const Spacer(),
                  Text('₹ 20/week', style: AppTypography.small.copyWith(fontWeight: FontWeight.w900, color: AppColors.brandPrimary)),
                ],
              ),
            ),
            const SizedBox(height: 24),
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: Text('VIEW POLICY DETAILS', style: AppTypography.bodySmall.copyWith(color: Colors.white, fontWeight: FontWeight.w900, letterSpacing: 1)),
              ),
            ),
          ],
        ),
