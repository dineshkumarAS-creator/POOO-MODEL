              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: claim['status'] == 'Paid' ? const Color(0xFFE8F5E9) : (claim['status'] == 'Rejected' ? const Color(0xFFFFEBEE) : (claim['status'] == 'Under Review' ? const Color(0xFFFFF7ED) : const Color(0xFFFFF3E0))),
                    ...
                    child: Column(
                      ...
                      children: [
                        RichText(
                          text: TextSpan(
                            style: TextStyle(
                              color: claim['status'] == 'Paid' ? const Color(0xFF1B5E20) : (claim['status'] == 'Rejected' ? const Color(0xFFB71C1C) : (claim['status'] == 'Under Review' ? const Color(0xFFEA580C) : const Color(0xFFE65100))),
                              fontSize: 34,
                              fontWeight: FontWeight.bold,
                              letterSpacing: -0.5,
                            ),
                            children: [
                              TextSpan(text: (claim['status'] == 'Rejected' || claim['status'] == 'Under Review') ? '₹0 ' : '₹${claim['amount']} '),
                              TextSpan(
                                text: claim['status'] == 'Paid' ? 'paid' : (claim['status'] == 'Rejected' ? 'denied' : (claim['status'] == 'Under Review' ? 'under review' : 'coming')),
                        ...
                        Text(
                          claim['status'] == 'Under Review' 
                            ? '⏳ Formal appeal in progress (SLA: 24h)'
                          ...
                          style: TextStyle(
                            color: claim['status'] == 'Paid' ? const Color(0xFF2E7D32) : (claim['status'] == 'Rejected' ? const Color(0xFFC62828) : (claim['status'] == 'Under Review' ? const Color(0xFF9A3412) : const Color(0xFFEF6C00))),
                            fontSize: 15,
                  ...
                  if (claim['status'] == 'Paid' || claim['status'] == 'Rejected' || claim['status'] == 'Under Review') ...[
                    ...
                    if (claim['status'] == 'Under Review')
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            const SizedBox(width: 12),
                            Expanded(child: Text('Under Specialist Review. You will be notified via SMS.', style: TextStyle(color: Colors.orange.shade900, fontSize: 13, fontWeight: FontWeight.w500))),
                          ],
                        ),
                      )
                    else
                      OutlinedButton(
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => FileClaimScreen(
                                  isResubmit: true,
                                  claimId: claim['id'],
                                  isAppeal: true, // Formal appeal path
                                ),
                              ),
                            );
                          }
                        ...
                        child: Text(
                          claim['status'] == 'Paid' ? 'Download claim receipt' : 'LAUNCH FORMAL APPEAL',
                          style: TextStyle(color: claim['status'] == 'Paid' ? AppColors.primary : Colors.red.shade700, fontWeight: FontWeight.bold, fontSize: 16),
                        ),
                      ),
