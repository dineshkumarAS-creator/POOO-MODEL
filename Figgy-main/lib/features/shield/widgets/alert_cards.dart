...
class AppealStatusCard extends StatelessWidget {
  const AppealStatusCard({super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: Colors.orange.withOpacity(0.04), blurRadius: 4, offset: const Offset(0, 2)),
        ],
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              const Text('Formal Appeal Progress', style: TextStyle(color: Color(0xFF6B7280), fontSize: 11, fontWeight: FontWeight.w500)),
              Container(
                ...
                child: Text('Under Review', style: TextStyle(color: Colors.orange.shade900, fontSize: 10, fontWeight: FontWeight.bold)),
              ),
            ],
          ),
          const SizedBox(height: 12),
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 6),
               Text(
                'SLA: Specialist review within 24h',
          ...
          const SizedBox(height: 16),
          const Text(
            'Your evidence is being manually verified by our team. You will be notified of the outcome via SMS.',
            style: TextStyle(color: Color(0xFF6B7280), fontSize: 11, fontWeight: FontWeight.w500, height: 1.4),
          ),
          const SizedBox(height: 20),
          InkWell(
            onTap: () {
            ...
            child: Container(
              ...
              child: const Row(
                ...
                children: [
                  Text(
                    'View Details',
                    style: TextStyle(color: Color(0xFFEA580C), fontSize: 13, fontWeight: FontWeight.bold),
                  ),
                  SizedBox(width: 8),
                  Icon(Icons.arrow_forward, size: 14, color: Color(0xFFEA580C)),
                ],
              ),
            ),
          ),
